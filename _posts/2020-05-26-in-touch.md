...
So I knew about the silence that MP3 adds at end. But after figuring out [which question to ask Google](https://sound.stackexchange.com/questions/35705/why-do-mp3-files-have-a-time-delay-when-compared-to-wav-files), I found out that it also adds silence at the start of the file.
